...
import styles from "@/app/css/table_order.module.css";

export default function UserDetalis({ user, orders }) {
      ...
      <Container>
        ...
        <Grid container spacing={1}>
          ...
          <Grid xs={12} md={9} item>
            ...
            >
              <ListItem>
                <TextField variant="filled" label="Name" value={user.name} />
              </ListItem>
              <ListItem>
                <TextField variant="filled" label="Phone" value={user.phone} />
              </ListItem>
              <ListItem>
                <TextField variant="filled" label="Email" value={user.email} />
              </ListItem>
            </List>
            <List
              sx={{
