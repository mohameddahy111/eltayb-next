                        ...
                        {cartItems?.map((ele, index) => (
                          <TableRow  className="table_row" key={index}>
                            ...
                            {ele.price !== ele.final_price ? (
                              <TableCell>
                                <Typography>
                                  <span className="discont"> {ele.price}</span>
                                  {ele.final_price}
                                  {""} LE
                                </Typography>
                              </TableCell>
                            ...
                            <TableCell sx={{position:'absolute' ,  right:'30px' , border:'none'}}>
                              <LoadingButton  className="table-icon"  onClick={()=>removeItem(ele._id)}>
                                <Delete color="error" />
                              </LoadingButton>
                            </TableCell>
                          </TableRow>
